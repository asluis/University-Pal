...
//    @Published public var image:Image
    ...
    init(title:String = "", author:String = "", ISBN:String = "", subject:String = "", price:Float = 0.0, image:UIImage? = UIImage(named: "")){
        self.title = title
        self.author = author
        self.ISBN = ISBN
    ...
    func setBookValues(title:String? = nil, author:String? = nil, ISBN:String? = nil, subject:String? = nil, price:Float? = nil, image:UIImage? = nil){
        if title != nil {
            self.title = title!
        }
        if author != nil {
    ...
    enum SubjectList : String, CaseIterable, Identifiable{
